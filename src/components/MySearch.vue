    ...
    <div class="weui_search_bar" id="search_bar" :class="{weui_search_focusing: !isCancel}">
      <form onsubmit="return false;" class="weui_search_outer">
        ...
        <div class="weui_search_inner">
          ...
          <input type="text" class="weui_search_input" id="search_input" placeholder="{{placeholder}}" autocomplete="off" required v-model="value" v-el:input v-on:blur="changeHandle"/>
